...
class MatplotlibVisualizer:
    ...
    def create_demographic_bar_chart(self,
                                     ...
                                     x_label: Optional[str] = None,
                                     y_label: Optional[str] = None,
                                     add_neutral_line: bool = True) -> Figure:
        """
        ...
        bars = ax.bar(agg_df[x_col], agg_df[y_col], 
    ...
    def create_line_chart(self,
        ...
        ax.axhline(y=3, color='red', linestyle='--', 
                  linewidth=1.5, label='Neutral', alpha=0.5)
    ...
    def create_net_score_bar(self,
        ...
        bars = ax.bar(agg_df[x_col], agg_df[sentiment_col], 
